...
export const MOOD_OPTIONS: MoodOption[] = [
  { label: '大喜', value: 'ecstatic', score: 10, emoji: '🤩', color: 'bg-emerald-500', shadow: 'shadow-emerald-200', suggestions: ['狂欢', '成就感', '奇迹'] },
  { label: '开心', value: 'happy', score: 8, emoji: '🥰', color: 'bg-teal-500', shadow: 'shadow-teal-200', suggestions: ['顺利', '美食', '聚会'] },
  { label: '平静', value: 'calm', score: 6, emoji: '🌿', color: 'bg-cyan-500', shadow: 'shadow-cyan-200', suggestions: ['阅读', '冥想', '放空'] },
  { label: '焦虑', value: 'anxious', score: 4, emoji: '😰', color: 'bg-amber-500', shadow: 'shadow-amber-200', suggestions: ['压力', '催促', '未知'] },
  { label: '难过', value: 'sad', score: 3, emoji: '😭', color: 'bg-violet-500', shadow: 'shadow-violet-200', suggestions: ['挫折', '孤独', '遗憾'] },
  { label: '生气', value: 'angry', score: 2, emoji: '😡', color: 'bg-rose-600', shadow: 'shadow-rose-200', suggestions: ['不公', '争吵', '被误解'] },
  { label: '崩溃', value: 'broken', score: 1, emoji: '🧟', color: 'bg-fuchsia-700', shadow: 'shadow-fuchsia-300', suggestions: ['绝望', '极度压抑', '爆发'] },
];
